    ...
    <nav class="navbar navbar-dropdown navbar-expand-lg">
        <div class="container">
            ...
            <ul class="navbar-nav navbar-nav-main nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black display-4" href="index.php">
                ...
                <li class="nav-item"><a class="nav-link link text-black display-4" href="#product">
                    Products
                </a></li>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav sidbar-nav nav-dropdown" data-app-modern-menu="true">
                    ...
                    <li class="nav-item"><a class="nav-link link text-black display-7" href="#product">
                        Products
                    </a></li>
                ...
                <div class="navbar-buttons mbr-section-btn align-center"><a class="btn btn-black display-7" href="cart.php">
                        Cart</a></div>
            </div>
        </div>
    </nav>
